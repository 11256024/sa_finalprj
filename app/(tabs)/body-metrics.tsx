...
export default function BodyMetricsScreen() {
  ...
  useEffect(() => {
    try {
      ...
      console.error("同步 Profile 資料時發生錯誤：", error);
    }
  }, []);
      ...
      <View style={styles.content}>
        ...
        <View style={styles.metricsLayout}>
          ...
          <View style={styles.bmrSection}>
            <View style={styles.bmrCard}>
              ...
              <View style={styles.bmrList}>
                ...
                <View style={styles.bmrRow}>
                  ...
                  {Platform.OS === 'web' ? (
                    ...
                    >
                      <option value="" style={{ color: '#333333' }}>四捨五入到整數</option>
              ...
              <View style={styles.resultRow}>
                ...
                {!hasHeightData ? (
                  <Text style={[styles.errorRedText, { fontSize: 20, marginLeft: 10 }]}>請至會員中心輸入身高數據</Text>
                ) : (
          ...
          <View style={styles.tdeeSection}>
            {/* 💡 核心修改：標題 Box 固定在最上層，不塞入下方的 ScrollView 裡 */}
            ...
            {/* 💡 核心修改：只有下方的運動項目卡片包在獨立的 ScrollView 裡滾動 */}
            <ScrollView 
...
const styles = StyleSheet.create({
  ...
  // 💡 限制主佈局高度與 BMR 卡片對齊，好讓右側超出高度時能精準觸發局部滾動
